...
python ppl_eval.py  --model "/home/zhangtr/WorkSpace/models/llama-2-7b-hf/"  --act_scales_path act_scales/llama-2-7b.pt  --smooth  --group-quantize  --alpha 1 --use-vq  --assignment-chunk-size 32  --dataset wikitext2
